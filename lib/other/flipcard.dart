...
class HomePageFlipCard extends StatefulWidget {
  @override
  _HomePageState createState() => _HomePageState();
}

class _HomePageState extends State<HomePageFlipCard> {
              ...
              Padding(
                ...
                child: ListTile(
                  ...
                  title: Padding(
                    ...
                    child: Text('Achintha Rajakaruna', style: TextStyle(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Container(child: Text('Colombo', style: TextStyle(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 8.0),
                    child: Container(
                      child: Text('achintharajakaruna@gmail.com', style: TextStyle(
                        color: Color(0xffff520d),
                        fontSize: 20.0,
                      ),),),
                  ),
          ...
          child: Container(
              child: Row(children: <Widget>[
                ...
                Padding(
                  padding: const EdgeInsets.only(left: 8.0),
                  child: Container(
                    child: Text('/achishaya', style: TextStyle(
                      color: Color(0xffff0d41),
                      fontSize: 24.0,),),),
                ),
              ],)
